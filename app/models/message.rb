class Message
  ...
  def library(input)
    phrase_library = {
      ...
      'x' => ["river danse ","freedom ","don't Picard the ","centipede bakery ","Cobra lessons ","sliming at noon ",". No can't ","catastrophic wonderfarts ","beer gazelle racing to bar ","candy-striped chickadee "],
