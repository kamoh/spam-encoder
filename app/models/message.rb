class Message < ActiveRecord::Base
  ...
  def library(input)
    phrase_library = {
      ...
      e: ["on SALE NOW ","elbows akimbo ","fornight fever? ","textile gremlins eating ","burger queen in her fiefdom ","hand-sewn gin coozies ","turkey says gubernatorial ","radio city best buy circuit ","bicycle handymen waitin for ","mattress to a trampoline, she said "],
      ...
      s: ["cold tomatoes for ","salad of pure ragu ","That one guy said ","do that, with your time left on Earth ","the fat guys coalition ","baby shower for dirty chidlren ","i am real person ","Google told me in whispers ","hard breakup for lettuce ","the worst 7 Best Dog Winks "],
      ...
      I: ["forty cravens ","leopard queens ",". Listening is pointless, ","give a chance? Nope ","scratch it like just that ","couch dovetailing on ","smooth, glittery ","pumpernickel astronaut ","the next election cyclon ","clothing is underwearrated ","astronomical mistakes "], 
